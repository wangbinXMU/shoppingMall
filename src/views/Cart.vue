<template>
  <div>
    ...
    <nav-bread>
      <span slot="bread" style="font-weight:bold;">我的购物车</span>
    </nav-bread>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                  <!--如果没有商品选中则结算按钮禁用（变灰），并且点击后无效，只有有商品选中时点击才会跳转-->
